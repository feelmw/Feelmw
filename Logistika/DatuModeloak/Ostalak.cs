...
namespace FeelmwLogistika.Logistika.DatuModeloak
{
    public class Ostalak
    {
        ...
        public Ostalak(string oi, string b, string h, string ci, string co, string doc, string ha, /*string gosK, string bazK, string afaK,*/ bool t, bool i, bool lu, string luK, string ins)
        {
            ostalaIzena = oi;
            bonoa = b;
            helbidea = h;
            ...
            harrera = ha;
            /*
            this.gosariates = gosK;
            this.bazkariates = bazK;
            this.afariates = afaK;
            */
            toailak = t;
            izarak = i;
        ...
        public Ostalak(string oi, string b, string h, string l, int g, string d, string ge, string ci, string co, string doc, string ha, string gosK, string bazK, string afaK, bool t, bool i, bool f, string fK, bool lu, string luK, string ins, bool esKlasikoa = false)
            {
                ...
                lokalizatzailea = esKlasikoa ? string.Empty : l;
                gauak = esKlasikoa ? 0 : g;
                datak = esKlasikoa ? string.Empty : d;
                gelak = esKlasikoa ? string.Empty : ge;
                checkin = ci;
                checkout = co;
                dokumentazioa = doc;
                harrera = ha;
